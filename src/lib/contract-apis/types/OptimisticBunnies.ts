...
export interface OptimisticBunniesInterface extends utils.Interface {
  functions: {
...
export interface OptimisticBunnies extends BaseContract {
  connect(signerOrProvider: Signer | Provider | string): this;
  attach(addressOrName: string): this;
  deployed(): Promise<this>;

  interface: OptimisticBunniesInterface;
